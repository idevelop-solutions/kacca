    ...
    <div class="gallery py-5" id="gallery">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-5 text-wh font-weight-bold">Updates about us:
                <span>@if($news->category == 'event') {{'Event'}}@else {{'News'}} @endif</span>
            </h3>
            <div class="news-grids gal text-center">
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col">
                            	<img src="{{URL::asset($news->photo)}}" class="img img-responsive img-fluid">	
                            </div>
                            <div class="col">
                            	<p>{{$news->description}}</p>
                            	<span>Published date: {{$news->created_at->diffForHumans()}}</span>	
                            </div>
